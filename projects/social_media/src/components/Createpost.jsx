...
function Createpost(){
  ...
  return( <><form className="create-post" onSubmit={handleSubmit}>
    <div class="mb-3">
    <label htmlfor="userId" class="form-label">Enter your Id</label>
  ...
  <div class="mb-3">
    ...
    <textarea type="text"
    rows="4" class="form-control" id="title"
    ref={postBodyElement}
  ...
  <div class="mb-3">
   ...
   <div class="mb-3">
    <label htmlfor="tags" class="form-label">enter your hashtag here</label>
